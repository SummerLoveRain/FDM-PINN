...
import numpy as np
import torch
from parabolic.PINN_fictitious import PINN

TASK_NAME = 'task_pinn_fictitious'
...
if __name__ == "__main__":
    ...
    psi1_layers = [3, 20, 20, 20, 20, 1]
    psi2_layers = [3, 20, 20, 20, 20, 1]
    param_dict = {
        'lb': lb,
        'ub': ub,
    ...
    for i in X:
        ...
        if delta >= 0:
            ...
            for t in T:
                if x2_1 == x2_2:
                    if t == 0:
                        X_init.append([x1, x2_1, t])
                    else:
                        X_gamma.append([x1, x2_1, t])
                else:
                    if t == 0:
                        X_init.append([x1, x2_1, t])
                        X_init.append([x1, x2_2, t])
                    else:
                        X_gamma.append([x1, x2_1, t])
