...
import numpy as np
import torch
from elliptic.PINN_origin_p2p import PINN

TASK_NAME = 'task_pinn_origin_p2p'
...
if __name__ == "__main__":
    ...
    N_points = 1
    X_Region_idx = np.random.choice(X_Region.shape[0], N_points)
    X_Region = X_Region[X_Region_idx, :]
    X_gamma_idx = np.random.choice(X_gamma.shape[0], N_points)
    X_gamma = X_gamma[X_gamma_idx, :]
