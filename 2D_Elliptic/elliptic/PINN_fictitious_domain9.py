...
class PINN(nn.Module):
    ...
    def loss_omega(self):
        ...
        # # 改为MSE
        # loss_J = self.loss_func(
        #     psi2, psi1) + self.loss_func(psi1_x1, psi2_x1) + self.loss_func(psi1_x2, psi2_x2)
    ...
    def optimize_one_epoch(self):
        ...
        self.loss = loss_Omega * alpha_Omega + loss_J*alpha_J +\
