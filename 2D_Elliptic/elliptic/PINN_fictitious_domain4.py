...
class PINN(nn.Module):
    ...
    def net_psi(self, x1, x2):
        ...
        psi1 = g * psi1 + self.g0(x1, x2)
        return psi1, psi2, v

    # 前向函数
    def forward(self, x1, x2):
        psi1, psi2, v = self.net_psi(x1, x2)
    ...
    # Omega区域损失
    def loss_Omega(self, use_v=False):
        x1 = self.X_Omega[:, 0:1]
        x2 = self.X_Omega[:, 1:2]
        psi1, psi2, v = self.net_psi(x1, x2)
    ...
    def optimize_one_epoch(self):
        ...
        if np.remainder(self.nIter, loss_remainder) == 0:
            ...
            log_str = str(self.optimizer_name) + ' Iter ' + str(self.nIter) + ' Loss ' +\
                str(loss) + ' loss_Omega ' + str(loss_Omega) + ' loss_v ' + str(loss_v) + ' loss_omega1 ' + str(loss_omega1) +\
