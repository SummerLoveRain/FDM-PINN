...
class PINN(nn.Module):
    ...
    def loss_Omega(self):
        ...
        equation = self.alpha * psi1 - self.mu * \
            (psi1_x1_x1 + psi1_x2_x2) - self.f(x1, x2)
    ...
    def optimize_one_epoch(self):
        ...
        if np.remainder(self.nIter, loss_remainder) == 0:
            ...
            log_str = str(self.optimizer_name) + ' Iter ' + str(self.nIter) +\
                ...
                ' loss_omega ' + str(loss_omega) + ' loss_J ' + str(loss_J) +\
