...
if __name__ == "__main__":
    ...
    # 在图上画点
    file_name = root_path + '/' + TASK_NAME + '/' + TIME_STR + '/scatter'
    plot_heatmap(X, Y, np.abs(u_true-u_pred), xlabel='x1',
                 ylabel='x2', file_name=file_name, scatter_x=[1.08, 2.07], scatter_y=[2.59, 1.88])
